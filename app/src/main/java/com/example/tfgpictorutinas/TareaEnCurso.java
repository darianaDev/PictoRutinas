        ...
        queryTarea.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for(DataSnapshot data: dataSnapshot.getChildren()){
                    ...
                    aux = new Tarea((Long)dataHash.get("idTarea"),(String)dataHash.get("nombreTarea") ,(String)dataHash.get("fotoTarea"),(Long) dataHash.get("duracion"),(Long) dataHash.get("rutina_id"));
               ...
               /* String[] partesHora = aux.getDuracion();
